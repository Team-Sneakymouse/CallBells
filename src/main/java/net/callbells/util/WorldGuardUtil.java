...
public class WorldGuardUtil {
	...
	public static boolean canBuildAtLocation(Player player, org.bukkit.Location bukkitLocation) {
		if (worldGuardPlugin == null || player.isOp() || player.hasPermission("worldguard.bypass")
		...
		return (regionManager == null || regionManager.getApplicableRegions(blockVector)
				.testState(worldGuardPlugin.wrapPlayer(player), Flags.BUILD));
	}
